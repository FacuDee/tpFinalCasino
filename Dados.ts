...
export class Dados {
  ...
  public comenzarjugo(apuesta: number): number {
    ...
    if (resultado1 == 7 || resultado1 == 11) {
      ...
      console.log(
        "Felicitaciones, Natural, Ha Ganado en el Primer tiro ",
        apuesta,
        " $"
      );
      ...
      // Inicia el ciclo POINT
      let resultado2: number;
      resultado2 = 1;
      console.log(
        "Establece un POINT, con el resultado ",
        resultado1,
        ", tira nuevamente: "
      );
      while (resultado2 != resultado1 && resultado2 != 7) {
        ...
        if (resultado1 == resultado2) {
          ...
          console.log(
            "HA GANADO :",
            apuesta,
            " ya que el primer tiro :",
            resultado1,
            " es igual al nuevo tiro :",
            resultado2,
            " es POINT "
          );
          ...
          console.log(
            "La suma de los dados es ",
            resultado2,
            " no coinciden, tira nuevamente: "
          );
        } else {
          console.log(
            "Ha Perdido el juego, ya que Sacaste ",
            resultado2,
            " Seven Out "
          );
          apuesta = 0;
  ...
  public validarApuesta() {
    let eleccionApuesta: number = parseInt(
      rsl.question("Cuanto desea apostar?? : "),
      10
    );
    while (eleccionApuesta < 5 || eleccionApuesta > this.getsaldo()) {
      // mayor a saldo y mayor que apuesta minima 5
      console.log(
        "Ingrese nuevamente la puesta debe ser menor al saldo y mayor a 5 (apuesta Minima)"
      );
